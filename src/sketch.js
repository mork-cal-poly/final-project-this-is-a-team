...
function draw() {
  ...
  if (scene == "left") {
    // Draw desk surface for left scene
    fill(139, 69, 19); // Brown color for the desk surface
    rect(50, 250, 250, 25);

    // Draw desk legs for left scene
    fill(139, 69, 19); // Brown color for the legs 
    let legWidth = 20;
    let legHeight = 130;
    rect(90, 270, legWidth, legHeight); // Top-left leg
    rect(250, 270, legWidth, legHeight); // Top-right leg

    // Draw monitor stand for left scene
    let standWidth = 10; 
    let standHeight = 35; 
    fill(169); // Gray color for the stand
    rect(180, 180 + standHeight, standWidth, standHeight); // Monitor stand

    // Draw monitor for left scene
    fill(50); // Dark gray color for the monitor
    let monitorWidth = 120;
    let monitorHeight = 75;
    rect(125, 150, monitorWidth, monitorHeight); // Monitor screen
    
    // Draw screen inside the monitor for left scene
    let screenWidth = 110;
    let screenHeight = 60;
    fill(135, 206, 250); 
    rect(130, 158, screenWidth, screenHeight); // Screen inside the monitor
